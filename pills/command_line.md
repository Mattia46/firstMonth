...
If you don't have access to either a Mac or Linux machine you may find it easier to work with a cloud hosted solution such as [c9.io](https://www.c9.io/).
...
Don't forget that you can access the history of your commands by pressing up and down arrows, so if you want to run the command you typed in a minute ago, just press the up arrow until you see it.
